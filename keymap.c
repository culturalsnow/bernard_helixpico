...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | CtEn |   A  |   S  |   D  |   F  |   G  |             |   H  |   J  |   K  |   L  |   '  |  \   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Shf( |   Z  |   X  |   C  |   V  |   B  |             |   N  |   M  |   ,  |   .  |   /  |Shf)  |
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |Adjust| Ctrl  | Alt  | GUI  | Lower |Bspc |Del/Ct |Ent |Space | Raise | Left | Up |  Down  |Rt   |
   * `-------------------------------------------------------------------------------------------------'
   */
...
[_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_LCTL,  KC_LALT, KC_LGUI, LOWER, KC_BSPC, LCTL_T(KC_DEL),  KC_ENT,  KC_SPC,   RAISE,    KC_LEFT, KC_UP, KC_DOWN,   KC_RGHT \
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
   ...
   */
  [_LOWER] = LAYOUT( \
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   _______, KC_HOME, _______, KC_END, _______, _______, \
      _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_EQL,  _______,                   _______, _______, _______, _______, KC_COLN, _______, \
   ...
   */
  [_RAISE] = LAYOUT( \
      _______, _______, _______, KC_LCBR, KC_LBRC, _______,                   _______, KC_RBRC, KC_RCBR, _______, _______, _______, \
